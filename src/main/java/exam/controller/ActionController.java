...
public class ActionController {
    ...
    public String attend(@PathVariable int id, Model model) {
        List<AttendanceDetailt> attendanceDetailtList = attendanceDetailtModel.findByAttendanceSlots_Id(id);
        model.addAttribute("id", id);
        model.addAttribute("attendanceDetailtList", attendanceDetailtList);
        return "attend";
    }
